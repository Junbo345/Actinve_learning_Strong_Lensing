...
Here we will investigate two loss functions, ranknet loss and focal loss. Ranknet loss is sepcified as follow: Given training data $x_1$, $x_2$, .... , $x_n$, and their rankings, $y_1$, $y_2$, ..., $y_n$, we will investigate all combinations of ordered pairs ($x_i$, $x_j$). The total loss is: 
$$
